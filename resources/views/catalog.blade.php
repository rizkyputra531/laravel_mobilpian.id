{{-- ini tempat untuk menampilkan halaman landing/index dari website nya --}}
<x-front-layout>
    <!-- Hero -->
    ...
    <section class="bg-darkGrey">
        <div class="container relative py-[100px]">
            <header class="mb-[30px]">
                ...
                <p class="text-base text-secondary">Mulai hari besar mu</p>
            </header>

            <!-- Cars -->
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-[29px]">
                {{-- kalau mau ngelooping/pengulangan data, pakai fitur @foreach  @endforeach --}}
                ...
                <div class="card-popular">
                    <div>
                        ...
                        <p class="text-sm font-normal text-secondary">{{ $item->brand ? $item->brand->name : '-'}}</p>
                    ...
                    <div class="flex items-center justify-between gap-1">
                        ...
                        <p class="text-sm font-normal text-secondary">
                            <span class="text-base font-bold text-primary">Rp. {{ number_format($item->price )}}</span>/hari
                        </p>
                        <!-- Rating -->
