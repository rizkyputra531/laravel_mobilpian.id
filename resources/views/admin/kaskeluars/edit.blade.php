<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">
            ...
            {!! __('Kas Keluar &raquo; Edit Data &raquo;') !!} {{ $kas_keluar->name }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-6xl mx-auto overflow-hidden bg-white shadow-xl sm:px-6 lg:px-8 sm:rounded-lg">
            ...
            @endif
            <form class="w-full" action="{{ route('admin.kaskeluars.update', $kas_keluar->id) }}" method="post"
                ...
                <div class="flex flex-wrap px-3 mt-10 mb-6 -mx-3">
                    <div class="w-full">
                        ...
                        <input value="{{ old('name') ?? $kas_keluar->name }}" name="name"
                ...
                <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                    <div class="w-full">
                        ...
                        <select name="jenis_pengeluaran"
                            ...
                            <option value="Rutin" {{ $kas_keluar->jenis_pengeluaran == 'Rutin' ? 'selected' : '' }}> Rutin</option>
                            <option value="Sosial" {{ $kas_keluar->jenis_pengeluaran == 'Sosial' ? 'selected' : '' }}> Sosial</option>
                            <option value="Asuransi" {{ $kas_keluar->jenis_pengeluaran == 'Asuransi' ? 'selected' : '' }}> Asuransi</option>
                            <option value="Operasional" {{ $kas_keluar->jenis_pengeluaran == 'Operasional' ? 'selected' : '' }}> Operasional</option>
                            <option value="Klaim Garansi" {{ $kas_keluar->jenis_pengeluaran == 'Klaim Garansi' ? 'selected' : '' }}> Klaim Garansi</option>
                            <option value="Cicilan Utang" {{ $kas_keluar->jenis_pengeluaran == 'Cicilan Utang' ? 'selected' : '' }}>Cicilan Utang</option>
                ...
                <div class="flex flex-wrap px-3 mt-10 mb-6 -mx-3">
                    <div class="w-full">
                        ...
                        <input value="{{ old('keterangan') ?? $kas_keluar->keterangan }}" name="keterangan"
                            class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                ...
                <div class="grid grid-cols-2 gap-6 px-3 mt-4 mb-10 -mx-3">
                    <div class="w-full">
                        ...
                        <div class="relative ">
                            ...
                            <input datepicker datepicker-autohide type="text" value="{{ old('tanggal') ?? $kas_keluar->tanggal}}" name="tanggal"
                    ...
                    <div class="w-full">
                        ...
                        <input value="{{ old('quantity') ?? $kas_keluar->quantity }}" name="quantity"
                            class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                ...
                <div class="grid grid-cols-2 gap-6 px-3 mt-4 mb-10 -mx-3">
                    <div class="w-full">
                        ...
                        <input value="{{ old('harga') ?? $kas_keluar->harga }}" name="harga"
                            class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                    ...
                    <div class="w-full">
                        ...
                        <input value="{{ old('total') ?? $kas_keluar->total}}" name="total"
                            class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
