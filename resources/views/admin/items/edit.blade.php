<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">
            ...
            {!! __('Item &raquo; Edit Data :') !!} {{ $item->name}}
            ...
            <form class="w-full" action="{{ route('admin.items.update', $item->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                    <div class="w-full">
                        ...
                        <div class="mt-2 text-sm text-gray-500">
                            Fitur Item. Contoh: AC 2 Baris, Bensin Irit, Tempat Bagasi Luas. (Maksimal 255 karakter
                ...
                <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                    <div class="w-full">
                        ...
                        <input name="photos[]"
                            class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                            accept="image/png, image/jpeg, image/jpg, image/webp" id="grid-last-name" type="file"
                            multiple>
                        <div class="mt-2 text-sm text-gray-500">
                            Foto Item, bisa upload lebih dari satu foto.
                        </div>
                    </div>
                </div>

                <div class="grid grid-cols-3 gap-6 px-3 mt-4 mb-10 -mx-3">
                    <div class="w-full">
                        <label class="block mb-2 text-xs font-bold tracking-wide text-gray-700 uppercase"
                            for="grid-last-name">
                            Harga*
                    ...
                    <div class="w-full">
                        ...
                        <input value="{{ old('star') ?? $item->star}}" name="star"
                            class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="number" placeholder="Rating"
                            main="1" max="5" step=".01"
                            required>
                        <div class="mt-2 text-sm text-gray-500">
                            Rating Item. Angka. Contoh: 5. wajib diisi
                        </div>
                    </div>
                    ...
                    <div class="w-full">
                        ...
                        <div class="mt-2 text-sm text-gray-500">
                            Review Item. Angka. Contoh: 1000. wajib diisi
                        </div>
                    </div>
